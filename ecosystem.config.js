module.exports = {
  ...
  deploy: {
    production: {
      ...
      'post-deploy':
        'pm2 deploy production setup && npm install && npm run build && pm2 deploy production setup && pm2 startOrRestart ecosystem.config.js --env production && pm2 save && git checkout package-lock.json',
      env: {
