module.exports = {
  ...
  deploy: {
    production: {
      ...
      'post-deploy':
        'npm install && npm run build && pm2 deploy ecosystem.config.js production setup && pm2 restart ecosystem.config.js --env production && pm2 save && git checkout package-lock.json',
      env: {
