module.exports = {
  ...
  deploy: {
    production: {
      ...
      'post-deploy':
        'npm install && npm run build && pm2 start ecosystem.config.js --env production && pm2 restart ecosystem.config.js --env production && pm2 save && git checkout package-lock.json',
      env: {
