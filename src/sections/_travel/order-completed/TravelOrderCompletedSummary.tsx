...
export default function TravelOrderCompletedSummary() {
  return (
    ...
    >
      ...
      <LineItem icon="carbon:calendar" label="Departure day" value={fDate(new Date(), false)} />
      ...
      <LineItem icon="carbon:calendar" label="Booking day" value={fDate(new Date(), false)} />
...
function LineItem({ icon, label, value }: any) {
  return (
    <Stack
      direction="row"
      alignItems="center"
