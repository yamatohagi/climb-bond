...
export default function TravelTourDetailsSummary({ tour }: any) {
  const {
    program,
    includes,
    location,
...
function OverviewItem({ icon, label, text = '-' }: any) {
  return (
...
function HighlightItem({ label, text }: any) {
  return (
    <Stack spacing={1}>
      <Typography
        variant="subtitle1"
