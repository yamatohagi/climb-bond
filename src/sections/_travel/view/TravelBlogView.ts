...
export default function TravelBlogView() {
  return (
    <>
      ...
      // @ts-expect-error TS(2749): 'BlogTravelTrendingTopics' refers to a value, but ... Remove this comment to see the full error message
      <BlogTravelTrendingTopics />
      ...
      >
        ...
        <Grid container spacing={{ md: 8 }}>
          // @ts-expect-error TS(2749): 'Grid' refers to a value, but is being used as a t... Remove this comment to see the full error message
          <Grid xs={12} md={8}>
            // @ts-expect-error TS(2709): Cannot use namespace 'BlogTravelPosts' as a type.
