...
export function StarIcon(props: any) {
  ...
  return (
    ...
    <SvgIcon {...props}>
      // @ts-expect-error TS(2304): Cannot find name 'polygon'.
...
export function CheckboxIndeterminateIcon(props: any) {
  // @ts-expect-error TS(2364): The left-hand side of an assignment expression mus... Remove this comment to see the full error message
  return (
    // @ts-expect-error TS(2749): 'SvgIcon' refers to a value, but is being used as ... Remove this comment to see the full error message
    <SvgIcon {...props}>
...
export function RadioIcon(props: any) {
  // @ts-expect-error TS(2364): The left-hand side of an assignment expression mus... Remove this comment to see the full error message
  return (
    // @ts-expect-error TS(2749): 'SvgIcon' refers to a value, but is being used as ... Remove this comment to see the full error message
    <SvgIcon {...props}>
...
export function RadioCheckedIcon(props: any) {
  // @ts-expect-error TS(2364): The left-hand side of an assignment expression mus... Remove this comment to see the full error message
  return (
    // @ts-expect-error TS(2749): 'SvgIcon' refers to a value, but is being used as ... Remove this comment to see the full error message
    <SvgIcon {...props}>
...
export function InputSelectIcon(props: any) {
  return (
    // @ts-expect-error TS(2749): 'SvgIcon' refers to a value, but is being used as ... Remove this comment to see the full error message
    <SvgIcon
      {...props}
      ...
      sx={{
        ...
        // @ts-expect-error TS(2695): Left side of comma operator is unused and has no s... Remove this comment to see the full error message
        top: 'calc(50% - 8px)',
        // @ts-expect-error TS(2304): Cannot find name 'pointerEvents'.
        pointerEvents: 'none',
      }}
    >
      // @ts-expect-error TS(2304): Cannot find name 'path'.
...
export function AutocompleteIcon(props: any) {
  return (
    // @ts-expect-error TS(2749): 'SvgIcon' refers to a value, but is being used as ... Remove this comment to see the full error message
...
//  Using for TreeView
export function TreeViewCollapseIcon(props: any) {
  // @ts-expect-error TS(2364): The left-hand side of an assignment expression mus... Remove this comment to see the full error message
  return (
    // @ts-expect-error TS(2749): 'SvgIcon' refers to a value, but is being used as ... Remove this comment to see the full error message
    <SvgIcon {...props}>
...
export function TreeViewExpandIcon(props: any) {
  // @ts-expect-error TS(2364): The left-hand side of an assignment expression mus... Remove this comment to see the full error message
  return (
    // @ts-expect-error TS(2749): 'SvgIcon' refers to a value, but is being used as ... Remove this comment to see the full error message
    <SvgIcon {...props}>
...
export function TreeViewEndIcon(props: any) {
  // @ts-expect-error TS(2364): The left-hand side of an assignment expression mus... Remove this comment to see the full error message
  return (
    // @ts-expect-error TS(2749): 'SvgIcon' refers to a value, but is being used as ... Remove this comment to see the full error message
    <SvgIcon {...props}>
